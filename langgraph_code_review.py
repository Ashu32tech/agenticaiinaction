...
def review_code(state: AgentState) -> AgentState:
    ...
    - Java file and line number if possible
...
def create_final_report(state: AgentState) -> AgentState:
    ...
    Include:
    1. Executive Summary
    2. List of Identified Vulnerabilities with file and line numbers stritly requested
...
if __name__ == "__main__":
    initial = {
        "code_url": "https://github.com/Ashu32tech/java-k8s-working-cluster-src/tree/main/three-microservices-full-working",
        "code_content": "",
        "security_issues": "",
        "suggestions": "",
        "final_report": ""
